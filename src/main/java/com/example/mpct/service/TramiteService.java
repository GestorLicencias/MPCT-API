...
public interface TramiteService {
    TramiteResponse crearTramite(String ruc, String representanteLegal, String rubro, String dni, String email, java.math.BigDecimal area, TipoTramite tipo, org.springframework.web.multipart.MultipartFile plano, java.util.List<org.springframework.web.multipart.MultipartFile> fotos);
